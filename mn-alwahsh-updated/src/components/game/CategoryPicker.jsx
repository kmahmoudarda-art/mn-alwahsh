...
const CATEGORY_GROUPS = {
  '⚽ رياضة': ['رياضة', 'CR7', 'ميسي', 'كأس العرب', 'كأس آسيا', 'Champions League', 'المنتخب الأردني', 'League of Legends', 'Real Madrid', 'Barcelona', 'Wild Rift', 'ريال مدريد', 'برشلونة', 'برشلونه', 'وايلد ريفت', 'wild rift'],
  ...
  '🎵 موسيقى وفنانون': ['أم كلثوم', 'عبد الحليم', 'حمو بيكا', 'تامر حسني', 'عمرو دياب', 'أغاني', 'أغاني قديمة'],
