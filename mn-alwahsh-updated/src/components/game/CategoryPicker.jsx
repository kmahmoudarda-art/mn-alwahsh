...
const CATEGORY_GROUPS = {
  ...
  '🧒 أطفال': ['kids', 'Kids', 'KIDS', 'kids guess', 'Kids Guess', 'Kids guess', 'KIDS GUESS', 'أطفال', 'عالم الأطفال', 'رسوم متحركة', 'كرتون', 'ديزني', 'Disney', 'بيبي شارك', 'Baby Shark', 'سبونج بوب', 'SpongeBob'],
