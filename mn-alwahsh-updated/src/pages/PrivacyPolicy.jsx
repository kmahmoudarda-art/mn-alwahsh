    ...
    <div style={{ minHeight: '100vh', background: '#050000', padding: '32px 16px' }}>
      <div dir="rtl" style={{
        ...
        <Section title="ما هي البيانات التي نجمعها؟">
          ...
          <p><b>فتح التطبيق:</b> عند فتح التطبيق، نسجّل نوع المنصة (تطبيق أندرويد أو موقع ويب) ومعلومات المتصفح/الجهاز العامة (User-Agent) — لقياس الاستخدام الفعلي للتطبيق، بدون ربط ذلك بهويتك.</p>
          <p><b>تسجيل الدخول:</b> عند تسجيل الدخول، نسجّل نوع المنصة (تطبيق أندرويد أو موقع ويب) مرتبطاً بالبريد الإلكتروني المستخدَم — لمعرفة من أي منصة يتم تسجيل الدخول.</p>
        </Section>
