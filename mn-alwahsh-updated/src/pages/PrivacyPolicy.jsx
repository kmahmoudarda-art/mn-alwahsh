    ...
    <div style={{ minHeight: '100vh', background: '#050000', padding: '32px 16px' }}>
      <div dir="rtl" style={{
        ...
        <Section title="ما هي البيانات التي نجمعها؟">
          ...
          <p><b>المشتريات:</b> عند شراء فئة مميزة عبر تطبيق أندرويد، نسجّل الفئة المشتراة وربطها بحسابك — لا نخزّن أبداً بيانات بطاقتك البنكية؛ الدفع يتم بالكامل عبر Google Play الذي يتولى معالجة معلومات الدفع بشكل مباشر.</p>
